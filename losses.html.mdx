...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/losses.py#L299"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/losses.py#L359"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
for q in quantiles:
    pd_vs_pl(
        quantile_loss(series, models, q=q),
        quantile_loss(series_pl, models, q=q),
        models,
    )
```
...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/losses.py#L589"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
