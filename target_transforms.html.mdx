...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/target_transforms.py#L92"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/target_transforms.py#L106"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/target_transforms.py#L126"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/target_transforms.py#L145"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
...
*Finds optimum lambda for each serie and applies Box-Cox
transformation.*
...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/target_transforms.py#L190"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>
