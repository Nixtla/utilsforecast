...
<a
href="https://github.com/Nixtla/utilsforecast/blob/main/utilsforecast/plotting.py#L45"
target="_blank" style={{ float: "right", fontSize: "smaller" }}>source</a>

### plot_series

> ``` text
>  plot_series (df:Union[pandas.core.frame.DataFrame,polars.dataframe.frame.
>               DataFrame,NoneType]=None, forecasts_df:Union[pandas.core.fra
...
|------|------------------|-------------------------|-------------------------|
| df | Union | None | DataFrame with columns \[`id_col`, `time_col`, `target_col`\]. |
