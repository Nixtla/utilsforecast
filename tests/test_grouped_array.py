# test _append_one
import numpy as np
from utilsforecast.grouped_array import _append_one, _append_several, GroupedArray
...
test_fail(lambda: ga.append(np.array([1.0, 2.0, 3.0])), contains="new must have 2 rows")
# build from df
