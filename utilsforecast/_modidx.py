  ...
  'syms': { 'utilsforecast.compat': {},
            ...
            'utilsforecast.target_transforms': { 'utilsforecast.target_transforms.BaseTargetTransform': ( 'target_transforms.html#basetargettransform',
                                                 ...
                                                 'utilsforecast.target_transforms.LocalMinMaxScaler': ( 'target_transforms.html#localminmaxscaler',
                                                                                                        'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalMinMaxScaler.fit_transform': ( 'target_transforms.html#localminmaxscaler.fit_transform',
                                                                                                                      'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalMinMaxScaler.inverse_transform': ( 'target_transforms.html#localminmaxscaler.inverse_transform',
                                                                                                                          'utilsforecast/target_transforms.py'),
                                                 ...
                                                 'utilsforecast.target_transforms.LocalRobustScaler.__init__': ( 'target_transforms.html#localrobustscaler.__init__',
                                                                                                                 'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalRobustScaler.fit_transform': ( 'target_transforms.html#localrobustscaler.fit_transform',
                                                                                                                      'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalRobustScaler.inverse_transform': ( 'target_transforms.html#localrobustscaler.inverse_transform',
                                                                                                                          'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalStandardScaler': ( 'target_transforms.html#localstandardscaler',
                                                                                                          'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalStandardScaler.fit_transform': ( 'target_transforms.html#localstandardscaler.fit_transform',
                                                                                                                        'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalStandardScaler.inverse_transform': ( 'target_transforms.html#localstandardscaler.inverse_transform',
                                                                                                                            'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._minmax_scaler_inverse_transform': ( 'target_transforms.html#_minmax_scaler_inverse_transform',
                                                                                                                       'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._minmax_scaler_transform': ( 'target_transforms.html#_minmax_scaler_transform',
                                                                                                               'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._robust_scaler_iqr_inverse_transform': ( 'target_transforms.html#_robust_scaler_iqr_inverse_transform',
                                                                                                                           'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._robust_scaler_iqr_transform': ( 'target_transforms.html#_robust_scaler_iqr_transform',
                                                                                                                   'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._robust_scaler_mad_inverse_transform': ( 'target_transforms.html#_robust_scaler_mad_inverse_transform',
                                                                                                                           'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._robust_scaler_mad_transform': ( 'target_transforms.html#_robust_scaler_mad_transform',
                                                                                                                   'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._standard_scaler_inverse_transform': ( 'target_transforms.html#_standard_scaler_inverse_transform',
                                                                                                                         'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._standard_scaler_transform': ( 'target_transforms.html#_standard_scaler_transform',
                                                                                                                 'utilsforecast/target_transforms.py')},
