  ...
  'syms': { 'utilsforecast.compat': {},
            ...
            'utilsforecast.target_transforms': { 'utilsforecast.target_transforms.BaseTargetTransform': ( 'target_transforms.html#basetargettransform',
                                                 ...
                                                 'utilsforecast.target_transforms.BaseTargetTransform.inverse_transform': ( 'target_transforms.html#basetargettransform.inverse_transform',
                                                                                                                            'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.BaseTargetTransform.inverse_transform_fitted': ( 'target_transforms.html#basetargettransform.inverse_transform_fitted',
                                                                                                                                   'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.BaseTargetTransform.set_column_names': ( 'target_transforms.html#basetargettransform.set_column_names',
                                                                                                                           'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalStandardScaler': ( 'target_transforms.html#localstandardscaler',
                                                                                                          'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalStandardScaler._invert_with_stats': ( 'target_transforms.html#localstandardscaler._invert_with_stats',
                                                                                                                             'utilsforecast/target_transforms.py'),
                                                 ...
                                                 'utilsforecast.target_transforms.LocalStandardScaler.inverse_transform': ( 'target_transforms.html#localstandardscaler.inverse_transform',
                                                                                                                            'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms.LocalStandardScaler.inverse_transform_fitted': ( 'target_transforms.html#localstandardscaler.inverse_transform_fitted',
                                                                                                                                   'utilsforecast/target_transforms.py'),
                                                 'utilsforecast.target_transforms._ensure_shallow_copy': ( 'target_transforms.html#_ensure_shallow_copy',
                                                                                                           'utilsforecast/target_transforms.py')},
