...
> ``` text
>  fourier (df:~DFType, freq:str, season_length:int, k:int, h:int=0,
...
> ``` text
>  trend (df:~DFType, freq:str, h:int=0, id_col:str='unique_id',
>         time_col:str='ds')
> ```
...
> ``` text
>  time_features (df:~DFType, freq:str, features:List[Union[str,Callable]],
...
> ``` text
>  pipeline (df:~DFType, features:List[Callable], freq:str, h:int=0,
>            id_col:str='unique_id', time_col:str='ds')
> ```
