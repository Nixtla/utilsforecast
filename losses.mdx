...
The Linex loss penalizes over- and under-forecasting asymmetrically depending on the parameter a. 
...
**Args:**
 ...
 - <b>`a`</b> (float, optional):  Asymmetry parameter. Must be non-zero. Defaults to 1.0. 
